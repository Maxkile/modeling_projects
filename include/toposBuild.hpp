...
VariableSizeMeshContainer<int> toLocalIndexes(const VariableSizeMeshContainer<int> &originEN, map<int, int> &G2L);
...
VariableSizeMeshContainer<int> build_topoEN(int Nx, int Ny, int k3, int k4, size_t submesh_id,
                                            const vector<pair<size_t, vector<int>>> &submeshes, map<int, int> &G2L,
