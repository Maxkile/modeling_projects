...
void write_file(FixedSizeMeshContainer<T1> &C, VariableSizeMeshContainer<T2> &topoEN,
                VariableSizeMeshContainer<T2> &topoSN, const std::string &path = "") {
    ofstream fout;
...
template <typename T1, typename T2>
int read_file(FixedSizeMeshContainer<T1> &C, VariableSizeMeshContainer<T2> &topoEN,
              VariableSizeMeshContainer<T2> &topoSN) {
    ifstream fin;
