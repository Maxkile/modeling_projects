 ...
 * id -> submesh coords
 */
pair<size_t, vector<int>> decomposeMesh(int Nx, int Ny, int Px, int Py, int px,
                                        int py);
 ...
 */
size_t getSubmeshIdByCoords(int x, int y,
 ...
 */
bool isHalo(int x, int y, const vector<pair<size_t, vector<int>>> &submeshes,
 ...
 * halo set
 */
void addHaloNodes(int x, int y,
                  const vector<pair<size_t, vector<int>>> &submeshes, int Nx,
                  int Ny, size_t current_id, set<int> &haloes);

/*
 * Forming part vector from inner,interface and halo nodes
 */
void formPart(vector<int> &part, const vector<int> &nodes,
              const vector<pair<size_t, vector<int>>> &submeshes, int Nx,
              int Ny);
