...
int topos::computeMeshFiguresNumberLeft(int figCount1, int figCount2, int skippedElemsCount, int curMeshFigureStructure)
{
...
VariableSizeMeshContainer<int> topos::toLocalIndexesTopoEN(VariableSizeMeshContainer<int>& originEN, map<int,int>& G2L)
{
...
//topoNN
VariableSizeMeshContainer<int> topos::build_topoNN(const VariableSizeMeshContainer<int>& topoSN){
    vector<int> BlockSize;
    vector<int> temp;
    vector<int> count_i_mas;
    vector<int> count_mass;
